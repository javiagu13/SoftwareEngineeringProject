...
public class gaizkiSartutaGUI extends JFrame {

	private JPanel contentPane;
	private gaizkiSartutaGUI frame;
	/**
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					gaizkiSartutaGUI frame = new gaizkiSartutaGUI();
	...
	public gaizkiSartutaGUI() {
		...
		JLabel lblDaturenBatGaizki = new JLabel("Daturen bat gaizki sartu da!");

...
public class pujaAdminItxiGUI extends JFrame {

	private JPanel contentPane;
	private pujaAdminItxiGUI frame;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					pujaAdminItxiGUI frame = new pujaAdminItxiGUI(ID, enk);
	 ...
	 * Create the frame.
	 */
	public pujaAdminItxiGUI(String ID, Enkante enk) {
		this.ID=ID;
		this.enk=enk;
		frame=this;

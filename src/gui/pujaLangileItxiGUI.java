...
public class pujaLangileItxiGUI extends JFrame {

	private JPanel contentPane;
	private pujaLangileItxiGUI frame;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					pujaLangileItxiGUI frame = new pujaLangileItxiGUI(ID, enk);
	 ...
	 * Create the frame.
	 */
	public pujaLangileItxiGUI(String ID, Enkante enk) {
		this.ID=ID;
		this.enk=enk;
		frame=this;
		...
		btnAtzera.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				langileGUI user = new langileGUI(ID);
		...
		JButton btnNewButton = new JButton("ENKANTEA ITXI!");
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				BLFacadeImplementation BL = new BLFacadeImplementation();
				BL.setIrabazle(enk.getIzena());
				lblNewLabel_1.setText("ENKANTEA ONDO ITXI DA!");
			}
		});
		btnNewButton.setFont(new Font("Tahoma", Font.PLAIN, 16));
		btnNewButton.setBounds(459, 321, 167, 91);
		contentPane.add(btnNewButton);
		
		lblNewLabel_1 = new JLabel();
		lblNewLabel_1.setFont(new Font("Tahoma", Font.PLAIN, 14));
		lblNewLabel_1.setBounds(459, 443, 193, 32);

...
public class pujaUserIkusiGUI extends JFrame {

	private JPanel contentPane;
	private pujaUserIkusiGUI frame;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					pujaUserIkusiGUI frame = new pujaUserIkusiGUI(ID, enk);
	 ...
	 * Create the frame.
	 */
	public pujaUserIkusiGUI(String ID, Enkante enk) {
		this.ID=ID;
		this.enk=enk;
		frame=this;
		...
		JLabel lblIrabazita = new JLabel("IRABAZITA!");
		lblIrabazita.setFont(new Font("Tahoma", Font.PLAIN, 24));
		lblIrabazita.setBounds(465, 368, 161, 40);
		contentPane.add(lblIrabazita);
